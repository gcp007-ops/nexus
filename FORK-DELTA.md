...
## Estado: zero divergência funcional (paridade 5.8.5)

Base: `origin/main` em `5.8.5` (`848c39a9`). v5.8.5 absorbeu #179 (commits `75f18123` / `1d308cbf`) e #181 (commit `68439360`); branches stacked locais foram arquivadas como referência histórica. `fix/parser-replace-content-not-found-normalization` (#182, NFC tolerance no `ContentReplaceTool`) permanece como única branch-offering ativa, rebased sobre v5.8.5.
